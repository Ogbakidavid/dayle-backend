...
export class NotificationsController {
    ...
    async simulateTelegramConnect(@User('id') userId: string, @Body('username') username: string) {
    ...
    async startWhatsAppVerification(@User('id') userId: string, @Body('phone') phone: string) {
    ...
    async confirmWhatsAppVerification(
        ...
        return this.notificationsService.confirmWhatsAppVerification(userId, body.code, body.consent);
    }
